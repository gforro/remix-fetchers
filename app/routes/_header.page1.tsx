  ...
  return (
    <main className="flex flex-col gap-2 items-center">
      ...
      <span className="ext-sm text-gray-500">
        Fetcher in page1 (20 seconds response): {fetcher.state}
      </span>
      <fetcherForm.Form method="post" className="flex items-end gap-2">
        ...
        <input
          ...
          value={
            fetcherForm.state === "idle" ? "Submit" : `${fetcherForm.state}...`
          }
        />
      </fetcherForm.Form>
